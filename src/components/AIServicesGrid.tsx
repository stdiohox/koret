...
// ✓ Responding to leads in seconds`;
  ...
  return (
    <MotionSection id="ai-agency" className="w-full bg-black py-24 px-4 md:px-8 text-white font-sans antialiased overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col gap-16">
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isActive ? 'bg-zinc-800 border-zinc-600' : 'bg-zinc-900 border-zinc-800 hover:border-zinc-700'
                    )}
                  >
                ...
                {consultationItems.map((c, idx) => (
                  <button
                    ...
                    className={cn(
                      ...
                      selectedItem === idx ? 'bg-zinc-800 border-zinc-600' : 'bg-zinc-900 border-zinc-800 hover:border-zinc-700'
                    )}
                  >
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950 p-6 flex flex-col justify-between transition-all duration-300 hover:border-zinc-700">
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-3 gap-2">
                {stack.map((s, idx) => (
                  <div key={idx} className="group/int p-3 rounded-lg bg-zinc-900 border border-zinc-800 hover:border-zinc-700 transition-all duration-200 flex flex-col items-center gap-1 cursor-pointer">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {stats.map((stat, idx) => (
            <div key={idx} className="group relative overflow-hidden rounded-xl border border-zinc-800 bg-zinc-950 p-4 transition-all duration-300 hover:border-zinc-700">
